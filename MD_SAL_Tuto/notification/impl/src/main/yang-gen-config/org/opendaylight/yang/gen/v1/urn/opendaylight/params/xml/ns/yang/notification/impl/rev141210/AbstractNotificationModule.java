...
public abstract class AbstractNotificationModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractNotificationModule> implements org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.notification.impl.rev141210.NotificationModuleMXBean {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.notification.impl.rev141210.AbstractNotificationModule.class);
    ...
    public AbstractNotificationModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public AbstractNotificationModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractNotificationModule oldModule,java.lang.AutoCloseable oldInstance) {
    ...
    public boolean canReuseInstance(AbstractNotificationModule oldModule){
    ...
    public boolean isSame(AbstractNotificationModule other) {
        if (other == null) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractNotificationModule that = (AbstractNotificationModule) o;
